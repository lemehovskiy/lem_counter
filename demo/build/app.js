    ...
    var LemCounter = function () {
        ...
        _createClass(LemCounter, [{
            ...
            value: function init() {
                ...
                var counter_from = self.settings.value_from;
